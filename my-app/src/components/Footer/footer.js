        ...
        return (
            <footer className="footer">
                ...
                <div className="footer__column">
                    ...
                    <li><a href="/" onClick = {(e) => this.handleLinkClick('home', e)} className="footer__link">Home</a></li>
                    <li><a href="/" onClick = {(e) => this.handleLinkClick('home', e)} className="footer__link">Catalog</a></li>
                    <li><a href="/" className="footer__link">Cart</a></li>
